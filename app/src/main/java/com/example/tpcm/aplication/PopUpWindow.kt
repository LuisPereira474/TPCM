...
class PopUpWindow : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        popup_window_view_with_border.radius = 30F
        popup_window_view_with_border.setPadding(0)
        popup_window_view_with_border.cardElevation = 100F
        popup_window_view_with_border.alpha = 0f
        popup_window_view_with_border.animate().alpha(1f).setDuration(100).setInterpolator(
